...
<html lang="en-AU">
  ...
  <body>
    ...
    <footer>
      <p>
        ~ Original design by <a href="https://github.com/chen-ky/" title="Chen Kang Yang's GitHub profile" target="_blank" rel="author">Chen Kang Yang</a> | All rights reserved | Icons by <a href="https://feathericons.com/" title="Feather website" target="_blank" rel="noopener">Feather</a> ~
      </p>
    </footer>
  </body>
</html>
