...
print("login, post, reply and report reply in the web framework forum")
vu1 = Virtual_user()
...
vu1.click_button('/html/body/div/div/article/form/select/option[5]')
...
vu1.quit()
print("Successfully reported reply in the web framework forum")
