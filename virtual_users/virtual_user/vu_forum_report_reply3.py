...
print("login, post, reply and report reply in the html forum")
vu1 = Virtual_user()
...
vu1.click_button('/html/body/div/div/article/form/select/option[3]')
...
vu1.quit()
print("Successfully reported reply in the html forum")
