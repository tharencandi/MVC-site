...
print("Start going through all webframework contents")
vu1 = Virtual_user()
vu1.click_button('//*[@id="content_cards"]/li[5]/a/div')
...
vu1.click_button('/html/body/nav[2]/a[7]')
vu1.click_button('/html/body/nav[2]/a[1]')
vu1.quit()
print("Successfully go through all webframework contents!")